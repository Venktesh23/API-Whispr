...
export default function AIFeatureShowcase({ isVisible, onClose }) {
  ...
  const features = [
    {
      icon: <Wrench className="h-6 w-6 text-[#888]" />,
    ...
    {
      icon: <GitCompare className="h-6 w-6 text-[#888]" />,
    ...
    {
      icon: <Shield className="h-6 w-6 text-[#888]" />,
      ...
      >
        ...
        <div className="p-6 overflow-y-auto max-h-[70vh]">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {features.map((feature, index) => (
              <motion.div
                ...
                className={`p-6 ${feature.color} rounded-xl border ${feature.borderColor}`}
              >
          ...
          <motion.div
            ...
            className="mt-8 p-6 bg-[#1a1a1a] border border-[#2a2a2a] rounded-xl"
          >
            <div className="flex items-center gap-3 mb-4">
              <Sparkles className="h-6 w-6 text-[#888]" />
              <h3 className="text-xl font-bold text-white">How to Use These Features</h3>
            </div>
            
            <div className="space-y-3 text-gray-300">
              <div className="flex items-start gap-3">
                <ArrowRight className="h-4 w-4 text-[#888] mt-0.5 flex-shrink-0" />
